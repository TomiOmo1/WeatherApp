...
export default {
  ...
  data () {
    return {
      api_key: '32e85087239c63836390c14279d3ffcd',
...
<style>
/* Include Istok Web font directly within the component */
...
.clouds {
  /* Add cloud animation styles here */
...
.rain {
  /* Add rain animation styles here */
  background: url('./assets/rain.png') repeat-y;
  height: 100px;
